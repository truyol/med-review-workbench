...
export type Asset = { id: string; case_id: string; kind: AssetKind; status: AssetStatus; source_label: string; content_type?: string | null; size_bytes: number; sha256: string; preview_available: boolean; metadata_summary: Record<string, unknown>; ingest_warnings: string[]; created_at: string; updated_at: string };
